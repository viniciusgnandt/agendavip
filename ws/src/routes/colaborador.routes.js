...
router.post('/', async (req, res) => {
  ...
  */
  ...
  try {
    ...
    // VERIFICAR SE JÁ EXISTE UM COLABORADOR COM ESSES DADOS
    ...
    if (!existentColaborador) {
      ...
      // VERIFICANDO ERRO NA CRIAÇÃO DA CONTA BANCÁRIA
    ...
    // SE NÃO HOUVER RELAÇÃO, CRIA RELACIONAMENTO
    ...
    // SE HOUVER RELAÇÃO E ESTIVER INATIVO, ATIVA NOVAMENTE
    ...
    */
    ...
    // VERIFICANDO SE JÁ EXISTIA UM COLABORADOR COM ESSES DADOS
...
/*
  BUSCA COLABORADORES DE UM SALÃO
*/
...
/*
  DELETAR VÍNCULO DE COLABORADOR COM SALÃO
*/
